...
const PHYSICS_DATA = {
    ...
    },
    {
      ...
      content: `
        ...
        <div class="tip-card info">
          ...
          <p>ดังนั้น $\\frac{g_h}{g_0} = \\left(\\frac{R}{2R}\\right)^2 = \\frac{1}{4}$ (ความเร่งโน้มถ่วงลดลงเหลือ $1/4$ ของที่ผิว)</p>
  ...
  masterExercises: [
    ...
    },
    {
      ...
      category: "freefall-radius-mass",
      categoryName: "เวลาตก + รัศมี ➔ มวลดาว",
      question: "ปล่อยวัตถุจากความสูงเท่ากันใกล้ผิวโลกและดาวเคราะห์ B พบว่าบนโลกใช้เวลา $1.5\\text{ s}$ ส่วนบนดาวเคราะห์ B ใช้เวลา $3.0\\text{ s}$ ถ้าดาวเคราะห์ B มีรัศมี $3$ เท่าของรัศมีโลก จงหาอัตราส่วนมวล $M_B / M_E$",
    ...
    },
    {
      ...
      category: "freefall-radius-mass",
      categoryName: "เวลาตก + รัศมี ➔ มวลดาว",
      question: "ปล่อยวัตถุจากความสูงเท่ากันบนดาวเคราะห์ P และ Q พบว่าใช้เวลา $2.0\\text{ s}$ และ $4.0\\text{ s}$ ตามลำดับ ถ้ารัศมีของ Q เป็น $2$ เท่าของรัศมี P จงหา $M_Q / M_P$",
    ...
    },
    {
      ...
      category: "weight-radius-mass",
      categoryName: "น้ำหนัก + รัศมี ➔ มวลดาว",
      question: "วัตถุก้อนเดียวกันหนัก $90\\text{ N}$ ที่ผิวดาวเคราะห์ P และหนัก $40\\text{ N}$ ที่ผิวดาวเคราะห์ Q ถ้ารัศมีของ Q เป็น $1.5$ เท่าของรัศมี P จงหา $M_Q / M_P$",
    ...
    },
    {
      ...
      solution: `
        <div class="solution-step">
          <p>หาความเร่งโน้มถ่วง $\\frac{g_A}{g_E} = \\frac{M_A/M_E}{(R_A/R_E)^2} = \\frac{9}{3^2} = \\frac{9}{9} = 1$</p>
    ...
    },
    {
      ...
      question: "ณ ผิวดาวเคราะห์หนึ่ง ความเร่งโน้มถ่วงมีค่า $g_0$ ถ้าขึ้นไปที่ความสูงเท่ากับรัศมีของดาวเคราะห์เหนือผิว (จึงอยู่ห่างจากศูนย์กลาง $2R$) จงหาอัตราส่วนของ $g$ ที่ตำแหน่งนั้นเทียบกับ $g_0$ ($g_h / g_0$)",
